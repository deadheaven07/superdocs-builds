...
export function useSuperDocs(apiKey: string): [SuperDocsState, SuperDocsActions] {
  ...
  return [state, { generateDocument, requestSurgicalEdits, approveChanges, continueJob, exportDocument, cancel, retry, dismissError, reset, resolveConflict, skipConflictCheck }];
}