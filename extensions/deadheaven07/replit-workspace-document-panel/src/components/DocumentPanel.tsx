  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        {/* Revision Check / Surgical Edit */}
        {lastContext && superDocsState.step === 'completed' && (
          <div className="mt-6 pt-4 border-t border-gray-200 space-y-3">
            <button onClick={handleSurgicalEdit} disabled={isProcessing} className="w-full px-4 py-2.5 bg-primary-100 text-primary-700 rounded-lg font-medium hover:bg-primary-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
              Check for Code Changes & Apply Surgical Edits
            </button>
            <p className="text-xs text-gray-500 text-center">Scans selected files for changes and requests SuperDocs to apply surgical edits to the existing document.</p>
